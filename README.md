...
Solving these problems taught me that the superiority of an algorithm is fundamentally tied to data structures (and hardware optimizations at some level), rather than just its theoretical complexity. Realizing it surprisingly required me way more documentation than I expected when beginning this project.
